...
TEST(ESCAPE, Valid_payload) {
    ...
    map<string, vector<LangExt::VarType>> fileselection;
    fileselection.emplace(IJsonable::escape(R"(C:\Users\github\anclient\examples\example.slint\build\app\libboost_url-gcc16-mt-d-x64-1_91.dll)"),
                          vector<LangExt::VarType>{"syncing"});
    fileselection.emplace(IJsonable::escape(R"(C:\Users\github\anclient\examples\example.slint\build\app\libcpr.dll)"),
                          vector<LangExt::VarType>{"syncing"});
...
TEST(ESCAPE, POSIX_path) {
    ...
    map<string, vector<LangExt::VarType>> fileselection;
    fileselection.emplace(Anson::escape_path(R"(C:\Users\github\anclient\examples\example.slint\build\app\libboost_url-gcc16-mt-d-x64-1_91.dll)"),
                          vector<LangExt::VarType>{"syncing"});
    fileselection.emplace(Anson::escape_path(R"(C:\Users\github\anclient\examples\example.slint\build\app\libcpr.dll)"),
                          vector<LangExt::VarType>{"syncing"});
